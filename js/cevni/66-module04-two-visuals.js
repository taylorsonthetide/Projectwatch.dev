(function(){
'use strict';
const BUILD='1.67.1-M04-TWO-VISUALS';
...
const patterns={
 ...
 5:{name:'Tow leader · viewing aspect',shape:'tow',note:'Article 3.09: separate forward and astern views of the towing leader.'},
 ...
 14:{name:'Distress and diving · distinct signals',shape:'status',note:'Red flare: distress signal (3.30). Rigid Code Flag A: diving vessel marking (3.36).'},
...
function art(x){
 if(!x)return '';
 if(x.shape==='tow')return '<figure class="pw166Art"><div class="pw166Name">'+x.name+'</div><div class="pw167VisualPair"><div><svg viewBox="0 0 100 104" role="img" aria-label="Forward view: two white masthead lights, one above the other"><circle cx="50" cy="26" r="7" fill="#fff"/><circle cx="50" cy="62" r="7" fill="#fff"/><path d="M19 94h62" stroke="#87b5cc" stroke-width="2"/></svg><b>From ahead · two white masthead lights</b></div><div><svg viewBox="0 0 100 104" role="img" aria-label="Aft view: yellow stern light"><circle cx="50" cy="58" r="8" fill="#ffd15c" stroke="#fff" stroke-width="1"/><path d="M19 94h62" stroke="#87b5cc" stroke-width="2"/></svg><b>From astern · yellow stern light</b></div></div><figcaption>'+x.note+' <small>Teaching schematics; other prescribed lights depend on aspect.</small></figcaption></figure>';
 if(x.shape==='status')return '<figure class="pw166Art"><div class="pw166Name">'+x.name+'</div><div class="pw167VisualPair"><div><svg viewBox="0 0 100 104" role="img" aria-label="Red hand flare representing a distress signal"><path d="M49 56v37" stroke="#d1e5ec" stroke-width="6"/><path d="M50 53C38 39 53 35 46 18c18 13 27 24 13 38z" fill="#f45c60" stroke="#fff" stroke-width="1.5"/></svg><b>Distress · red flare</b></div><div><svg viewBox="0 0 100 104" role="img" aria-label="Blue and white International Code Flag A marking a diving vessel"><path d="M17 7v91" stroke="#a9cbd8" stroke-width="3"/><path d="M19 12h62v24L68 46l13 10v23H19z" fill="#fff"/><path d="M19 12h31v67H19z" fill="#2462ac"/><path d="M19 12h62v24L68 46l13 10v23H19z" fill="none" stroke="#cbe9f3" stroke-width="2"/></svg><b>Diving · Code Flag A</b></div></div><figcaption>'+x.note+' <small>Signal sketches; the flag is displayed on the vessel in addition to its other marking.</small></figcaption></figure>';
...
window.PW1671_M04={build:BUILD,source:'CEVNI Rev.6 Chapter 3 / Annex 3',phase:'teaching-review',questionBankIntegrated:false,visualsAssessmentReady:false,module3Changed:false};
})();
