...
(function(){
  ...
  function install(){
    ...
    if(centralNote)centralNote.textContent='Unified library: each displayed Annex 7 sign image links to a checked source plate file. The seven text-only umbrella or pending records show their codes until a specific image can be verified.';
