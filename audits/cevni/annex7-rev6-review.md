...
## Build 1.81.0 progress

The learner register now has 111 cards. Fifty-four cards link to individual PNG crops from the Rev.6 Annex 7 source (30 family A, 17 family B, six D.1 variants and E.2). A.1 and E.1 retain source-aligned Project Watch teaching boards, making 56 displayed images. The remaining 55 cards are code-only and labelled as unverified artwork. The source images are separate files in `assets/cevni/annex7/rev6/`, referenced by paths from the catalogue.

The B family gained all 17 distinct plates on printed pp. 130–134, including the missing B.12 onshore-power obligation. B.7 now uses the source plate instead of the old teaching disc. The A family gained 29 new plates after the initial A.2, plus 11 distinct A.1/A.9/A.11 variant records. A.10 remains pending the Corrigendum 2 replacement figure. Generic A.9 and A.11 remain text-only headings. See the asset [provenance note](../../assets/cevni/annex7/rev6/README.md).
...
The original 99-card register was **not a complete plate index**. Annex 7 has 33 further distinct variant or sign codes. Twelve are now added (11 in A, B.12); 21 remain:

- C: `C.1a–b`, `C.2a–b`, `C.3a–b`, `C.5a–b`.
